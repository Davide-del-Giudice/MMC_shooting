...
Dc_TEM dc  uic=2 print=yes nettype=1 iabstol=1u sparse=3 fixsm=no digmode=2 save="new.op" load="PF.op" 

TEM_BASIC_tran_startup tran nettype=1 stop=TSTOP devvars=true saman=true 	\
		            annotate=3 method=2 maxord=2 cmin=false acntrl=3    \
		 	    sparse=2 tinc=1 uic=2 dgionly=true tmin=1n          \
