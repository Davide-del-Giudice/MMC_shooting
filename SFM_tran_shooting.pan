...
parameter Save =    ["slk_va","slk_vb","slk_vc",                      		\
                     ...
                     "CmC1.CONV.iza","CmC1.CONV.izb","CmC1.CONV.izc",           \
                     "CmA1.CONV.pow_mod",                                       \
                     ...
                     "CmA1.CONV.iza","CmA1.CONV.izb","CmA1.CONV.izc",           \
                     "CmC1.cap_up_a","CmC1.cap_up_b","CmC1.cap_up_c",           \
                     "CmC1.cap_dw_a","CmC1.cap_dw_b","CmC1.cap_dw_c",           \
                     "CmA1.cap_up_a","CmA1.cap_up_b","CmA1.cap_up_c",           \
                     "CmA1.cap_dw_a","CmA1.cap_dw_b","CmA1.cap_dw_c"]



// FAIR COMPARISON WITH SHM SHOULD BE ENSURED: SAME PARAMETERS AS SHOOTING SHOULD BE USED
SFM_tran_shooting_short tran nettype=1 stop=0.35 devvars=true saman=1 load="NordicSfm.sh" \
	    	       annotate=4 method=2 maxord=2 cmin=false acntrl=2 sparse=2     \
		       tinc=1 dgionly=false tmin=1u tmax=0.01/F0 skip=2              \
		       iabstol=1u  vabstol=1u vreltol=1u ireltol=0.01m               \
		       chgcheck=no checkstrange=no savelist=Save uic=2

SFM_tran_shooting tran nettype=1 stop=TSTOP devvars=true saman=1 load="NordicSfm.sh" \
	    	       annotate=4 method=2 maxord=2 cmin=false acntrl=3 sparse=2     \
		       tinc=1 dgionly=false tmin=1u tmax=0.01/F0 skip=2              \
		       iabstol=1u  vabstol=1u vreltol=1u ireltol=0.01m               \
		       chgcheck=no checkstrange=no savelist=Save uic=2
