...
load('SFM_TRAN_SHOOTING.mat');
load('SFM_TRAN_SHOOTING_SHORT.mat');                                        % just for insets in the right-side panels
load('SFM_TRAN_STARTUP.mat');
...
for hor=1:nx
    for ver=1:ny
        ...
        if ver == 1
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.slk_ia(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.slk_ia(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 2
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.BmC1_pos(1:DEC:end)*2,'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');
            
            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.BmC1_pos(1:DEC:end)*2,'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 3
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.CmA1_pow(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.CmA1_pow(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 4
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.CmA1_i_up_a(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.CmA1_i_up_a(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 5
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.CmC1_drv_up_a(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.CmC1_drv_up_a(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 6
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.CmC1_cap_up_a(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.CmC1_cap_up_a(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        ...
        elseif ver == 7
            ...
            line(SFM_TRAN_STARTUP.time(1:DEC:end),SFM_TRAN_STARTUP.omega9(1:DEC:end),'Color', black, ...
                'LineWidth', linwid1, 'Linestyle','-');

            hold on

            if hor == 2
                line(SFM_TRAN_SHOOTING.time(1:DEC:end),SFM_TRAN_SHOOTING.omega9(1:DEC:end),'Color', red, ...
                    'LineWidth', linwid1, 'Linestyle','-.');
            end
            grid on
        end
        ...
        elseif ver == 6 && hor == 1
          ...
          axlbl={'$$t [\mathrm{s}] $$','$$ v_{u_a}^{\mathrm{tot}} \, [\mathrm{kV}] $$'};
            text(0.014,0.74,axlbl{2}, ...
                'fontname','times',...
                'fontangle','italic',...
                'fontsize',fnl, ...
...
format_ticks(inset1,{'$99.98$','$ $','$99.99$','$ $','$100$'},...
    {'$403.8$','$ $','$404.3$','$ $', '$404.8$'},...
    linspace(100-1/F0,100,5),  linspace(403.8e3,404.8e3,5),[],[],[0.080 0.010]);
axlbl={'$$ $$','$$ $$'};
...
format_ticks(inset2,{'$99.98$','$ $','$99.99$','$ $','$100$'},...
    {'$384$','$ $','$386$','$ $', '$388$'},...
    linspace(100-1/F0,100,5),  linspace(384e6,388e6,5),[],[],[0.080 0.010]);
axlbl={'$$ $$','$$ $$'};
...
inset3 = axes(...
    'units','normalized',...
    'position',[0.85 0.775, 0.083 0.05],...
    'fontsize',fnt,...
    'fontname','helvetica',...
    'fontangle','normal',...
    'visible','on', ...
...
line(SFM_TRAN_SHOOTING_SHORT.time(1:DEC:end),SFM_TRAN_SHOOTING_SHORT.BmC1_pos(1:DEC:end)*2,'Color', red, ...
    'LineWidth', linwid1, 'Linestyle','-');
grid on

set(inset3, 'Xgrid', 'on', 'Ygrid', 'on');

format_ticks(inset3,{'$0.15$','$ $','$0.17$'},...
    {'$403.8$','$ $','$404.3$','$ $', '$404.8$'},...
    linspace(0.15,0.15+1/F0,3),  linspace(403.8e3,404.8e3,5),[],[],[0.080 0.010]);
axlbl={'$$ $$','$$ $$'};
...
line(SFM_TRAN_SHOOTING_SHORT.time(1:DEC:end),SFM_TRAN_SHOOTING_SHORT.CmA1_pow(1:DEC:end),'Color', red, ...
    'LineWidth', linwid1, 'Linestyle','-');
grid on
...
format_ticks(inset4,{'$0.15$','$ $','$0.23$','$ $','$0.31$'},...
    {'$385$','$ $','$385.5$','$ $', '$386$'},...
    linspace(0.15,0.15+8/F0,5),  linspace(385e6,386e6,5),[],[],[0.080 0.010]);
axlbl={'$$ $$','$$ $$'};

if(prn)
    print -loose -painters -depsc2 ..\Figures\SFM.eps
end